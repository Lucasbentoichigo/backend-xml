...
export const buscarTodos = async (req, res) => {
    try {
        ...
        return sendXml(res, 200, { data: registros });
    } catch (error) {
...
export const buscarPorId = async (req, res) => {
    try {
        ...
        return sendXml(res, 200, { data: exemplo });
    } catch (error) {
        console.error('Erro ao buscar:', error);
...
export const deletar = async (req, res) => {
    try {
        ...
        return sendXml(res, 200, { message: `O registro "${exemplo.nome}" foi deletado com sucesso!`, deletado: exemplo });
    } catch (error) {
